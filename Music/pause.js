...
module.exports = {
  ...
  execute(message) {
    ...
    if (queue.playing) {
      ...
      const pausemebed = new MessageEmbed().setColor("#8AD0DA")
      .setAuthor(`${message.author.username} paused the music.`, "https://cdn.discordapp.com/attachments/807677211133083698/878673480290291712/21-playpause.gif")
