...
module.exports = {
  ...
  try {
      ...
      const newsong = new MessageEmbed()
        .addField("<a:880146579519058030:882325635408723998> __Chill PLAYING MUSIC__")
        .setTitle(" <a:866116058329776198:882343139602497598> "+song.title)
        .addField("TIME DURATION <a:839946470018646056:882345971378438195> ",`\`  ${song.duration} Minutes  \``, true)
        .addField("Voice Channel <:817866288658514051:882346974093934613> ",channel.name)
